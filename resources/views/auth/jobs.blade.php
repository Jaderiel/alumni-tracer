                        ...
                        <div class="job-details">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex gap-2">
                                    <a href="{{ $job->link }}" class="apply-btn text-white px-4 py-1 rounded-sm" target="_blank">Apply</a>
                                    @if(Auth::check() && (Auth::user()->user_type === 'Super Admin' || Auth::user()->id === $job->user_id))
                                        <a href="{{ route('jobs.show', ['job' => $job->id]) }}">
                                            <button class="apply-btn text-white px-4 py-1 rounded-sm">Edit</button>
                                        </a>
                                    @endif
                                </div>
                            </div>
