...
<section id="interface" class="ml-0 lg:ml-[300px] w-full flex justify-center">
    ...
    <div class="privacy-section">
            <div class="notice">
                ...
                <div class="account">
                    <h4><strong>ACCOUNT DELETION POLICY</strong></h4>
                ...
                <div class="use">
                    <h4><strong>USE AND STORAGE OF DATA</strong></h4>
                ...
                <div class="opt-out">
                    <h4><strong>OPTING OUT AND DATA DELETION</strong></h4>
                ...
                <div class="updates">
                    <h4><strong>UPDATES TO THIS PRIVACY NOTICE</strong></h4>
